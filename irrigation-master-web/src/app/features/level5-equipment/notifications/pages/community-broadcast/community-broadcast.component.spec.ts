...
describe('CommunityBroadcastComponent', () => {
    ...
    // A diferencia de "Usuarios"/"Sectores", "Avisar a mi comunidad" SÍ incluye a Coordinador de
    // Riego -- espejo de ShowCommunityBroadcast en AdminMenuPage.xaml.cs de la App; el backend
    // solo exige el permiso SEND_NOTIFICATIONS, ya sembrado en ese rol.
